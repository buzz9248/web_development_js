 ...
 * break;의 의미도 중요.
 * 
 * : switch 문에서 case는 순서대로 실행되면서 검증.
 * 그러므로 break; 가 없다면 그 다음 case 까지 실행이 된다는 점에 유의할 필요가 있습니다.
 * 
 * 다 작성 후 Chapter03 폴더 생성
 * n00loops.js
 * index.html 생성
 */