...
// index.html 생성 -> 개발자 도구를 통해서 콘솔 확인이 가능합니다
...
// let b = a;
// console.log(a, b);  // 결과값 : 2 2 : 콤마(,)는 출력되지 않음
...
//    at n00hellojs.js: 28: 3

// let c = 10;  -> 동일한 변수를 두 번 선언했기 때문
// let c = 12;
// Uncaught SyntaxError: Identifier 'c' has already been declared (at n00hellojs.js:33:5) -> 라고 오류 발생
...
// 이상의 코드에서 알수 있는 점은 조건식에 자주 사용되고, 비교 연산의 결과값을 산출할 때 많이 사용
...
// console.log(a == c, a != c); // ture false
...
// 문자열의 경우 알파벳 순서상 뒤에 오는 것을 더 크다고 판단합니다.
